export const messages = {
  ptbr: {
    message: {
      ...
      projectTitle: 'Projetos recentes',
      projectOne: {
        projectOneText: 'Desenvolvedor fullstack na Bluecore.it',
        projectOneDesc: 'Responsável pela criação de softwares modernos e robustos usando Javascript e metodologias ágeis'
      },
      projectTwo: {
  ...
  en: {
    message: {
      ...
      projectOne: {
        projectOneText: 'Fullstack developer at Bluecore.it',
        projectOneDesc: 'Responsible for developing modern and robust software using Javascript and Agile methodologies.'
      },
      projectTwo: {
