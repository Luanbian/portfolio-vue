...
import { Project, BoxDesc, ProjectImage, ProjectTitle, ProjectDesc } from '../styles/project-styled'
...
export default defineComponent({
  ...
  components: { Project, BoxDesc, ProjectImage, ProjectTitle, ProjectDesc }
})
</script>
